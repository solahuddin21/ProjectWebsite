...
<body>
  ...
  <h1 class="text-center my-3 mb-5">Data Institusi</h1>
  <div class="container text-center mb-5">
    <a href="data_pendaftar_institusi.php"><button type="#" class="btn btn-warning text-center my-2"><i class="fas fa-clipboard-list"></i> List Data Pendaftar</button></a><br>
    <a href="log_daftar_institusi.php"><button type="#" class="btn btn-warning text-center my-2"><i class="far fa-sticky-note"></i> Log Data Pendaftar</button></a><br>
    <a href="data_peringkat_cabang_institusi.php"><button type="#" class="btn btn-warning text-center my-2"><i class="fas fa-sort-numeric-down"></i> Peringkat Cabang</button></a><br>
  </div>
